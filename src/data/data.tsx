export const experienceCard = [
  ...
  },
  {
    ...
    timeline: "Sep, 24 - Oct, 25",
    description: [
      "Trained in React.js and Laravel.",
      "Hands on experience in implementing react design patterns and backend using Laravel.",
      "Implemented RESTful APIs for monolithic architecture–based applications.",
    ],
...
export const projectCard = [
  {
    ...
    description: [
      ...
      "The app leverages a Deep learning model based on Convolutional Neural Network (CNN) computational technique.",
      "The model can predict skin disease with an accuracy of more than 97% which can be further improved by increasing the size of the dataset used to build the model.",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "Implemented JWT-based authentication and protected routes, ensuring secure access to user dashboards and order flows.",
      "Connected frontend with RESTful backend microservices, managing loaders, error states, and token-based requests.",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "The application provides necessary CRUD operations and is suitable for small restaurants with billing counters operated by an employee.",
      "Implemented an authentication system for security.",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "Create todos (mark as important), edit messages, toggle completed, delete items, search, and filter (All / Completed / Important / Todo)",
      "Developed a flexible theming and shared state solution in React using Context API and higher-order components.",
      "Functional components, hooks (useState, useEffect, useContext, useCallback), controlled inputs, and list rendering with key.",
      "React.memo + useCallback to avoid unnecessary re-renders, conditional styling for theme/state, and subtle side-effects (body styles) in useEffect.",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "UI split into reusable components with props-driven composition.",
      "Uses useState for grid, current chance, moves/logs, players, and editing state; state setters are passed down as props.",
      "Win/draw detection is encapsulated in checkWinner.tsx, keeping UI and logic decoupled.",
      "used typescript for typesaftey",
      "Project uses Vite for dev/build and Tailwind CSS utility classes for styling.",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "Applied modular styling for a consistent, responsive layout optimized for quick scanning on desktop and mobile.",
      "Implemented the restaurant menu as a single-page application using JavaScript and jQuery",
    ],
    link: "https://github.com/naveendanu2000/Food_ordering_site_mini_project.git",
  },
];
